    ...
    <div className="relative flex flex-col items-center justify-center">
      ...
      <div
        className={`border-l-1 pr-[0.62px] backdrop-blur flex-none relative ${
          hasNext ? "border-white/20 h-14" : "border-dashed border-white/50 h-8"
        }`}
      ></div>
      {hasNext ? (
        <>
          ...
          <div
            className="absolute w-3 h-3 rounded-full bg-black border hover:w-5 hover:h-5 flex items-center justify-center transition-all cursor-pointer border-white/20"
