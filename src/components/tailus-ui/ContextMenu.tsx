...
>(function ContextMenuItem(
  { className, intent, variant, ...props },
  forwardedRef
) {
  const { variant: contextVariant, intent: contextIntent } =
    React.useContext(MenuContext);
...
>(function ContextMenuSubContent(
  { className, variant = "soft", intent = "gray", mixed, fancy, ...props },
  forwardedRef
) {
  const {
    variant: contextVariant,
...
>(function ContextMenuCommand({ className, ...props }, forwardedRef) {
  const { command } = menu.solid({});
  return (
    <div {...props} ref={forwardedRef} className={command({ className })} />
  );
});
...
const ContextMenuIcon = React.forwardRef<
  React.ElementRef<"div">,
  React.ComponentPropsWithoutRef<"div"> & ContextMenuContentProps
>(function ContextMenuIcon({ className, ...props }, forwardedRef) {
