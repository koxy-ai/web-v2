...
>(function DialogOverlay({ className, ...props }, forwardedRef) {
...
>(function DialogContent({ className, fancy, mixed, ...props }, forwardedRef) {
...
>(function DialogDescription(
  { className, size, weight, align, neutral, ...props },
  forwardedRef
) {
  return (
...
>(function DialogActions({ className, ...props }, forwardedRef) {
